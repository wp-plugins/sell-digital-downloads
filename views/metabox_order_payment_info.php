...
<table class="form-table">
  ...
  <tr valign="top">
    ...
    <tr valign="top">
       ...
       <td>
          <input type="number" value="<?php echo $payment_info['amount_paid']; ?>" id="amount_paid" name="amount_paid"  /><span class="currency" style="font-weight:bold"><?php echo $currency; ?></span
        </td>
    </tr>
    <tr valign="top">
